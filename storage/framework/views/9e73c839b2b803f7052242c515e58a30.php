...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['onclick' => 'login()','class' => 'ms-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'login()','class' => 'ms-3']); ?>
...
<script>
function login() {
    window.location.href="/search_recipes";
}


</script><?php /**PATH C:\Users\katar\Desktop\recipe-finder1\resources\views/auth/login.blade.php ENDPATH**/ ?>